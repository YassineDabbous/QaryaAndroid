...
public class BaseActivity  extends AppCompatActivity implements ComponentCallbacks2 {
    ...
    public MyFragment currentFragment = null;
    ...
    protected void attachBaseContext(Context base) {
        ...
        BaseActivity.log("attachBaseContext");
    }
    ...
    public void clean(){
        BaseActivity.log("♣♣♣ BaseActivity clean "+ getClass().getName());
        //if(currentFragment!=null)
        //currentFragment.clean();
        System.gc();
    }
    public void init(){
        BaseActivity.log("♣♣♣ BaseActivity init "+ getClass().getName());
        //if(currentFragment!=null)
