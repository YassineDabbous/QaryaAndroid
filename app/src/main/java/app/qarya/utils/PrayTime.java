...
public class PrayTime {
    ...
    /*public static void main(String[] args){
        new PrayTime().getPrayerTimes(Calendar.get(), 32.9255721, 10.4608834,0);
    }*/

    public static String getTimes() {

        double latitude = 32.928763;
        double longitude = 10.4475053;
        double timezone = 1;
        ...
        prayers.setAsrJuristic(prayers.Shafii); //Hanafi
        ...
        for (int i = 0; i < prayerTimes.size(); i++) {
            times += prayerNames.get(i) + " - " + prayerTimes.get(i)+"\n";
        }
        return times;
    }
    ...
    public PrayTime() {
        ...
        timeNames.add("• صلاة الفجر");
        timeNames.add("شروق الشمس");
        timeNames.add("• صلاة الظهر");
        timeNames.add("• صلاة العصر");
        timeNames.add("غروب الشمس");
        timeNames.add("• صلاة المغرب");
        timeNames.add("• صلاة العشاء");
